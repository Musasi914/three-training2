...
export default class ExternalForce extends ShaderPass {
  ...
  render() {
    ...
    // 正規化されたカーソルの大きさ
    const cursorSizeX = this.props.cursorSize * this.props.cellScale.x;

    const cursorSizeY = this.props.cursorSize * this.props.cellScale.y;
    ...
    uniforms.scale.value.set(this.props.cursorSize, this.props.cursorSize);
